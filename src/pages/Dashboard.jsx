...
import { Grid3X3, ScanLine, History, PieChart, FileText, FileDigit } from 'lucide-react';
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <Card className="max-h-[300px] overflow-y-auto">
                <h3 className="font-bold mb-4 sticky top-0 bg-white dark:bg-slate-900/0 backdrop-blur-sm z-10">Log Aktivitas</h3>
                <div className="space-y-3">
                    {logs.map(log => (
                        <div key={log.id} className="flex justify-between text-sm border-b border-slate-100 dark:border-slate-800 pb-2">
                            <div>
                            ...
                            <div className="text-right text-xs text-gray-400">
                                {/* Handle potentially different log timestamp formats if needed, assuming Data Objects */}
